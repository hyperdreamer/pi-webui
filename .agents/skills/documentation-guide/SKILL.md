...
A reader should be able to understand what PI WEBUI is, decide whether it is relevant, satisfy the basic prerequisites, complete the shortest supported installation, and find the detailed documentation. Once that path is clear, additional explanation belongs under `docs/`.
...
- high-level capabilities that help someone decide whether to use PI WEBUI;
