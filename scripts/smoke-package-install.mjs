...
const MARKER = "pi-webui-package-pty-ok";
...
const root = await mkdtemp(join(tmpdir(), "pi-webui-package-install-"));
try {
  ...
  const packageRoot = join(globalPrefix, "lib", "node_modules", "@hyperdreamer", "pi-webui");
