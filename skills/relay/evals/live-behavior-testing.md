...
```text
/tmp/pi-webui-relay-live-evals/iteration-1/<eval-name>/
  sandbox/.pi-webui/relays/<relay-name>/
    charter.md
    status.md
    log.md
    work/...
...
Read:
- /tmp/pi-webui-relay-live-evals/.../sandbox/.pi-webui/relays/sandbox/charter.md
- /tmp/pi-webui-relay-live-evals/.../sandbox/.pi-webui/relays/sandbox/status.md
```
...
```text
/tmp/pi-webui-relay-live-evals/iteration-1/live-results.md
/tmp/pi-webui-relay-live-evals/iteration-1/live-results.json
```
