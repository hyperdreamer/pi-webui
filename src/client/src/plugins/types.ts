...
export interface PiWebUiUnstableRuntimeContext {
...
export interface PluginRuntimeContext {
  ...
  piWebUiUnstable?: PiWebUiUnstableRuntimeContext;
...
export interface WorkspacePanelContext extends WorkspaceContext {
   ...
   * This is intentionally not part of the public `@hyperdreamer/pi-webui/plugin-api` declarations.
   */
  openTerminal?: (options?: { terminalId?: string | undefined }) => void;
  piWebUiUnstable?: Pick<PiWebUiUnstableRuntimeContext, "terminalCommandRuns">;
