...
export const DEFAULT_THEME_ID: QualifiedContributionId = "themes:pi-webui-dark";
export const DEFAULT_THEME_PREFERENCE: ThemePreference = { themeId: DEFAULT_THEME_ID, auto: true };
export const THEME_STORAGE_KEY = "pi-webui-app-theme";
...
export function applyPiWebUiTheme(theme: QualifiedThemeContribution): void {
