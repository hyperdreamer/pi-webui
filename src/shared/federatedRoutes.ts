...
export const PI_PACKAGE_PLUGINS_OPERATION_PROXY_TIMEOUT_MS = 5 * 60_000;
export const SKILLS_OPERATION_PROXY_TIMEOUT_MS = 5 * 60_000;
...
export const FEDERATED_HTTP_ROUTES = [
  ...
  { method: "POST", path: "/skills/install", timeoutMs: SKILLS_OPERATION_PROXY_TIMEOUT_MS },
  { method: "POST", path: "/skills/check", timeoutMs: SKILLS_OPERATION_PROXY_TIMEOUT_MS },
  { method: "POST", path: "/skills/update", timeoutMs: SKILLS_OPERATION_PROXY_TIMEOUT_MS },
  { method: "GET", path: "/plugins" },
  { method: "GET", path: "/package-plugins" },
  { method: "POST", path: "/package-plugins", timeoutMs: PI_PACKAGE_PLUGINS_OPERATION_PROXY_TIMEOUT_MS },
  ...
  { method: "GET", path: "/sessions/:sessionId/export" },
