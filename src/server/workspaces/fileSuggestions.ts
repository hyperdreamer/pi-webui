...
export interface FileSuggestionOptions {
  ...
  pathAccess?: PiWebUiPathAccessConfig | undefined;
}
...
export async function listPathSuggestions(cwd: string, prefix = "", pathAccess?: PiWebUiPathAccessConfig, deps: FileSuggestionDependencies = {}): Promise<ClientFileSuggestion[]> {
...
async function listAllowedPathSuggestions(cwd: string, query: string, pathAccess: PiWebUiPathAccessConfig | undefined, fzf: CommandRunner | undefined): Promise<ClientFileSuggestion[]> {
